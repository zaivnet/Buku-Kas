<x-app-layout title="Tambah Outlet Baru">
    <div class="max-w-2xl mx-auto">
        {{-- Header --}}
        <div class="flex items-center justify-between mb-6">
            <div>
                <h1 class="text-xl font-bold text-neutral-text">Tambah Outlet Baru</h1>
                <p class="text-sm text-neutral-muted mt-1">Daftarkan outlet toko baru ke dalam sistem.</p>
            </div>
